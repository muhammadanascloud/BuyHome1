...
const properties: Property[] = [
  {
    ...
    description: [
      "Beautiful family home in a quiet suburb.",
  ...
  },
  {
    ...
    listingType: 'For Sale',
    description: [
      "Beautiful villa with bright and airy interiors.",
      "Close to parks and schools.",
      "Perfect for families seeking comfort."
    ],
    squareFootage: 2200,
    yearBuilt: 2021,
    pricePerSqFt: 313,
  ...
  },
  {
    ...
    listingType: 'For Sale',
    description: [
      "Beautifully designed lodge with modern finishes.",
  ...
  },
  {
    ...
    listingType: 'For Sale',
    description: [
      "Gorgeous residence with breathtaking canyon views.",
      "Open concept living space perfect for entertaining.",
